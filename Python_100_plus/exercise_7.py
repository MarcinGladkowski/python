...
Hints: Note: In case of input data being supplied to the question, it should be assumed to be a console input in
...
def generate(x: int, y: int):
    ...
    for i in range(x):
        first_dimension = []
        for j in range(y):
            first_dimension.append(j*i)
        result.append(first_dimension)
