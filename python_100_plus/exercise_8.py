...
class TestAlphabeticallySorting(unittest.TestCase):

    def test_should_sort_words_alphabetically(self):
        self.assertEqual('bag,hello,without,world', alphabetically('without,hello,bag,world'))
